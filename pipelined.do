...
add wave -noupdate /top_tb/soc/dut/controller/valid_id_i
add wave -noupdate /top_tb/soc/dut/controller/valid_ex_i
add wave -noupdate /top_tb/soc/dut/controller/valid_mem_i
add wave -noupdate /top_tb/soc/dut/controller/valid_wb_i
...
add wave -noupdate -group {IF STAGE} /top_tb/soc/dut/if_stage/block_if_i
add wave -noupdate -group {IF STAGE} /top_tb/soc/dut/if_stage/inject_nops_i
add wave -noupdate -group {IF STAGE} /top_tb/soc/dut/if_stage/valid_if_o
add wave -noupdate -group {IF STAGE} /top_tb/soc/dut/if_stage/instruction_hit_o
...
add wave -noupdate -group {IF STAGE} /top_tb/soc/dut/if_stage/pc_i
...
add wave -noupdate -group {IF STAGE} /top_tb/soc/dut/if_stage/pc
...
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/valid_if_i
...
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/rf_data_b_o
...
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/pc_o
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/is_jaljalr_o
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/block_id_i
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/inject_nops_i
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/valid_id_o
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/src_a_identifier_o
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/src_b_identifier_o
...
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/instr_d
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/pc_d
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/instr_q
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/pc_q
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/valid_id_d
add wave -noupdate -group {ID STAGE} /top_tb/soc/dut/id_stage/valid_id_q
...
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/valid_id_i
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/rf_data_b_i
...
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/pc_i
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/seq_new_pc_o
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/is_jaljalr_i
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/is_jaljalr_o
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/block_ex_i
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/inject_nops_i
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/valid_ex_o
...
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/alu_src_a_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/alu_src_b_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/rf_we_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/memop_sign_ext_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/memop_type_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/memop_rd_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/memop_wr_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/alu_opcode_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/br_src_a_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/br_src_b_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/memop_rf_data_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/seq_new_pc_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/is_jaljalr_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/rf_waddr_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/rf_st_data_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/valid_ex_d
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/alu_src_a_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/alu_src_b_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/rf_we_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/memop_sign_ext_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/memop_type_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/memop_rd_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/memop_wr_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/alu_opcode_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/br_src_a_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/br_src_b_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/memop_rf_data_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/seq_new_pc_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/is_jaljalr_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/rf_waddr_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/rf_st_data_q
add wave -noupdate -group {EX STAGE} /top_tb/soc/dut/ex_stage/valid_ex_q
...
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/valid_ex_i
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/cache_is_busy_o
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/cache_is_hit_o
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/cache_line_i
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/mem_ready_i
...
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/to_mem_cache_line_o
...
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/is_jaljalr_i
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/seq_new_pc_i
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/block_mem_i
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/inject_nops_i
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/valid_mem_o
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/read_cache_data
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/processed_read_cache_data
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/is_hit
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/is_busy
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/writeback
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/store_buffer_draining
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/to_mem_cache_line
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/memop_sign_ext_ff
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/check_if_hit
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/output_address
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/output_memop_type
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/output_data
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/muxed_memop_type
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/alu_res_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/rf_we_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/rf_waddr_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/rf_st_data_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/memop_type_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/memop_rd_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/memop_wr_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/memop_sign_ext_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/new_pc_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/is_jaljalr_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/seq_new_pc_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/tkbr_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/valid_mem_d
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/alu_res_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/rf_we_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/rf_waddr_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/rf_st_data_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/memop_type_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/memop_rd_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/memop_wr_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/memop_sign_ext_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/new_pc_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/is_jaljalr_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/seq_new_pc_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/tkbr_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/valid_mem_q
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/is_alu
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/aux_addr
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/aux_memop
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/aux_data
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/writeback_addr
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/rd
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/wr
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/writeback_mem_o
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/memop_rd_ff
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/memop_wr_ff
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/rf_we_ff
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/rf_waddr_ff
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/tkbr_ff
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/new_pc_ff
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/seq_new_pc_o
add wave -noupdate -group {MEM STAGE} /top_tb/soc/dut/mem_stage/is_jaljalr_o
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/clk_i
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/rsn_i
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/we_i
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/raddr_a_i
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/data_a_o
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/raddr_b_i
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/data_b_o
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/waddr_i
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/data_w_i
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/rf_reg
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/rf_reg_aux
add wave -noupdate -group {SEGRE REGISTER FILE} /top_tb/soc/dut/segre_rf/write_enable
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {290925 ps} 0}
